    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Members", x => new { x.UserId, x.ParentId, x.ParentType });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Members_ParentId_ParentType",
                table: "Members",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Members_UserId_ParentType",
                table: "Members",
                columns: new[] { "UserId", "ParentType" });
